...
android {
    namespace = "com.drakorid.stream"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.drakorid.stream"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
    ...
    signingConfigs {
        create("release") {
            ...
            if (ksPath != null) {
                ...
                keyAlias = System.getenv("DRAKORID_KEY_ALIAS")
                keyPassword = System.getenv("DRAKORID_KEY_PASSWORD")
            }
        }
    }
